                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <img src="{{(!empty($EditData->profile_photo_path))? url('upload/admin_images/'.$EditData->profile_photo_path):url('upload/no_image.jpg')}}" alt=""style="width: 100px; height: 100px">
                                            </div>  {{-- end col md 6--}}
                                        </div>  {{-- end row--}}
